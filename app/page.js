    ...
    <div style={{ background: '#121212', minHeight: '100vh', color: '#fff', fontFamily: '"Jost", sans-serif' }}>
      ...
      <footer style={{ background: '#0a0a0a', padding: '40px 15px', borderTop: '1px solid #222', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '20px', marginBottom: '20px' }}>
          ...
          <a href="/privacy" style={{ color: '#888', textDecoration: 'none', fontSize: '14px', transition: 'color 0.2s' }} onMouseOver={(e)=>e.target.style.color='#fff'} onMouseOut={(e)=>e.target.style.color='#888'}>Privacy Policy</a>
          <a href="/dmca" style={{ color: '#888', textDecoration: 'none', fontSize: '14px', transition: 'color 0.2s' }} onMouseOver={(e)=>e.target.style.color='#fff'} onMouseOut={(e)=>e.target.style.color='#888'}>DMCA</a>
        </div>
