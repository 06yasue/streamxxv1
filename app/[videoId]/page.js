...
export async function generateMetadata({ params }) {
  // Tambahan wajib untuk Next.js versi terbaru
...
export default async function VideoPlayerPage({ params }) {
  ...
  return (
    <div className="container-custom" style={{ padding: '0', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div style={{ padding: '20px' }}>
        <h2 style={{ marginTop: '0', fontSize: '22px', fontWeight: 'bold' }}>{video.title}</h2>
        <div style={{ display: 'flex', justifyContent: 'space-between', color: '#888', fontSize: '14px', marginTop: '15px', borderTop: '1px solid #333', paddingTop: '15px' }}>
